    ...
    >
      ...
      <div className="flex-1 flex flex-col lg:justify-center px-6 md:px-38 my-10 lg:my-6 text-center">
        ...
        <p className="text-base md:text-[19px] font-light mb-8 leading-tight tracking-wider">
          ...
          sectors, especially within government and insurance domains. The
          company specializes in a wide range of services, including software
          development, data processing and conversion, customer relationship
          management, web design, database solutions, data scanning, and BPO
        ...
        <p className="text-base md:text-[19px] font-light mb-8 leading-tight tracking-wider">
          ...
          underscoring its stability and credibility in the Indian corporate
          landscape.
        </p>
      </div>
    </div>
